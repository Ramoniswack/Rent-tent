      ...
      <div className="relative flex-grow w-full flex items-center justify-center overflow-hidden py-12">
        ...
        <div className="relative w-full max-w-[480px] bg-white dark:bg-[#152e26] rounded-2xl shadow-2xl p-12 z-10 mx-4 border border-white/50 dark:border-white/5">
          ...
          <button
            ...
            disabled={loading}
            className="w-full h-12 bg-white dark:bg-[#0f231d] border-2 border-slate-200 dark:border-[#2a453b] rounded-2xl font-medium text-[#0f231d] dark:text-white hover:bg-slate-50 dark:hover:bg-[#1a3329] transition-all duration-200 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
          >
