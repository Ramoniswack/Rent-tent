...
export default function AccountPage() {
  ...
  return (
    <ProtectedRoute>
      <Header />
      <div className="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 relative overflow-hidden pb-16 antialiased">
        ...
        <div className="flex flex-col lg:flex-row max-w-[1200px] mx-auto relative z-10 pt-4 px-4 sm:px-6 lg:px-8 gap-6 lg:gap-8">
          
          {/* Unified Sidebar Layout */}
          <aside className="w-full lg:w-72 shrink-0">
            <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl p-4 lg:p-6 shadow-xl ring-1 ring-slate-900/5 dark:ring-white/5 border border-slate-200/50 dark:border-slate-700/50 lg:sticky lg:top-24">
              
              <div className="hidden lg:flex items-center gap-3 mb-8 px-2">
                <div className="p-2.5 bg-[#059467]/10 dark:bg-[#059467]/20 rounded-xl">
                  <User className="w-6 h-6 text-[#059467]" />
                </div>
                <div>
                  <h2 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight">Account</h2>
                  <p className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Manage Details</p>
                </div>
              </div>
              ...
              <nav className="flex flex-row lg:flex-col gap-2 overflow-x-auto lg:overflow-x-visible pb-2 lg:pb-0 scrollbar-hide">
                {navItems.map(({ id, icon: Icon, label }) => (
                  ...
                  >
                    <Icon className={`w-5 h-5 ${activeTab === id ? 'text-white' : 'text-slate-400 dark:text-slate-500'}`} />
                    {label}
                  </button>
                ))}

                <div className="hidden lg:block w-full h-px bg-slate-200/50 dark:bg-slate-700/50 my-2" />
                
                <button
                  onClick={handleLogout}
                  className="flex items-center gap-3 px-4 py-3.5 rounded-2xl transition-all whitespace-nowrap lg:whitespace-normal font-bold text-sm text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-500/10 hover:text-rose-600 dark:hover:text-rose-400 shrink-0"
                >
                  <LogOut className="w-5 h-5 text-rose-400 dark:text-rose-500" />
                  Log Out
                </button>
              </nav>
            </div>
          ...
          {/* Main Content Area */}
          <main className="flex-1 w-full min-w-0 pb-32 lg:pb-12">
            <div className="p-0 lg:p-4">
              
              {/* Header Text */}
              <header className="mb-6 lg:mb-10 hidden lg:block">
                <h2 className="text-2xl lg:text-3xl font-black text-slate-900 dark:text-white tracking-tight mb-2">
              ...
              <div className="space-y-6 lg:space-y-8">
                ...
                {activeTab === 'profile' && (
                  <>
                    {/* Cover & Avatar Card */}
                    <section className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl border border-slate-200/50 dark:border-slate-700/50 p-1 shadow-sm">
                      <div className="relative group cursor-pointer rounded-[20px] overflow-hidden">
                        ...
                        <label htmlFor="cover-photo-upload" className="cursor-pointer block">
                          <div className="w-full h-40 lg:h-56 bg-slate-100 dark:bg-slate-900">
                            {uploadingCover ? (
                      ...
                      <div className="px-6 pb-6 pt-0 flex flex-col sm:flex-row gap-6 items-center sm:items-end -mt-12 lg:-mt-16 relative z-10">
                        <div className="relative group cursor-pointer shrink-0">
                          ...
                          <label htmlFor="profile-picture-upload" className="cursor-pointer block">
                            <div className="w-24 h-24 lg:w-32 lg:h-32 rounded-full overflow-hidden border-4 border-white dark:border-slate-800 bg-white dark:bg-slate-800 shadow-xl">
                              {uploadingImage ? (
                                <div className="w-full h-full flex items-center justify-center"><Loader2 className="w-8 h-8 text-slate-900 dark:text-[#059467] animate-spin" /></div>
                              ) : imagePreview ? (
                        ...
                        <div className="flex-1 w-full text-center sm:text-left pt-2">
                          <h3 className="text-xl lg:text-2xl font-black text-slate-900 dark:text-white truncate">{formData.name || 'Your Name'}</h3>
                    ...
                    {/* Basic Info Form */}
                    <section className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl border border-slate-200/50 dark:border-slate-700/50 p-5 lg:p-8 shadow-sm">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <input className="w-full bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-500 dark:text-slate-400 cursor-not-allowed opacity-70" type="email" value={userProfile?.email || ''} disabled />
                        </div>
                        <div className="space-y-1.5">
                    ...
                    <section className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl border border-slate-200/50 dark:border-slate-700/50 p-5 lg:p-8 shadow-sm">
                      ...
                      <div className="space-y-3">
                        ...
                        {[
                          ...
                          <div key={item.name} className="flex items-center justify-between p-4 bg-slate-50/50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-700/50 rounded-2xl hover:border-slate-200 dark:hover:border-slate-600 transition-colors">
                            <div>
                      ...
                      <div className="flex items-center justify-between mb-5">
                        <div>
                          <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2">
                            <Lock className="w-5 h-5 text-[#059467]" /> Change Password
                          </h4>
                        ...
                        {!showPasswordChange && (
                          <button
                            ...
                            className="px-4 py-2 bg-[#059467] text-white text-sm font-bold rounded-xl hover:bg-[#047854] transition-all shadow-md shadow-[#059467]/20"
                          >
                            Change
                          </button>
                        )}
                        ...
                        <div className="space-y-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                          <div className="space-y-1.5">
                            ...
                            <input
                              ...
                              className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-900 dark:text-white focus:ring-2 focus:ring-[#059467]/50 transition-all"
                          ...
                          <div className="flex gap-3 pt-2">
                            <button
                              ...
                              className="flex-1 px-4 py-2.5 border-2 border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 font-bold rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-all"
                            >
                              Cancel
                            </button>
                            <button
                              ...
                              className="flex-1 px-4 py-2.5 bg-[#059467] text-white font-bold rounded-xl hover:bg-[#047854] transition-all shadow-md shadow-[#059467]/20 disabled:opacity-70 flex items-center justify-center gap-2"
                            >
                              {changingPassword ? (
                                <>
                ...
                {activeTab === 'stats' && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
                    ...
                    <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl p-6 border border-slate-200/50 dark:border-slate-700/50 shadow-sm flex items-center justify-between hover:-translate-y-1 transition-transform duration-300">
                      <div>
                        ...
                        <span className="text-xs font-bold text-[#059467] flex items-center gap-1 bg-[#059467]/10 dark:bg-[#059467]/20 w-fit px-2 py-0.5 rounded-full">
                          <TrendingUp className="w-3 h-3" /> +{userStats.percentageIncrease}% this year
                        </span>
                      </div>
                      <div className="w-16 h-16 rounded-2xl bg-[#059467]/10 dark:bg-[#059467]/20 flex items-center justify-center text-[#059467]">
                    ...
                    <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl p-6 border border-slate-200/50 dark:border-slate-700/50 shadow-sm flex items-center justify-between hover:-translate-y-1 transition-transform duration-300">
                      ...
                      <div className="w-16 h-16 rounded-2xl bg-amber-500/10 dark:bg-amber-500/20 flex items-center justify-center text-amber-500">
                    ...
                    <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl p-6 border border-slate-200/50 dark:border-slate-700/50 shadow-sm flex items-center justify-between hover:-translate-y-1 transition-transform duration-300">
                      ...
                      <div className="w-16 h-16 rounded-2xl bg-purple-500/10 dark:bg-purple-500/20 flex items-center justify-center text-purple-600 dark:text-purple-400">
                    ...
                    <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl p-6 border border-slate-200/50 dark:border-slate-700/50 shadow-sm flex items-center justify-between hover:-translate-y-1 transition-transform duration-300">
                      ...
                      <div className="w-16 h-16 rounded-2xl bg-blue-500/10 dark:bg-blue-500/20 flex items-center justify-center text-blue-500">
                ...
                {/* ================= BLOCKED TAB ================= */}
                {activeTab === 'blocked' && (
                  <section className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl border border-slate-200/50 dark:border-slate-700/50 p-5 lg:p-8 shadow-sm min-h-[400px]">
                    {loadingBlocked ? (
       ...
       {/* Action Bar (Static) */}
        {['profile', 'settings', 'billing'].includes(activeTab) && (
          <div className="w-full p-4 lg:p-6 border-t border-slate-200/80 dark:border-slate-800/80 mt-8">
            <div className="max-w-[1200px] mx-auto flex gap-3 lg:justify-end lg:pl-[340px]">
              <button 
                onClick={handleCancel} 
                className="flex-1 lg:flex-none px-6 py-3 lg:py-3.5 rounded-2xl border-2 border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 font-bold hover:bg-slate-50 dark:hover:bg-slate-800 hover:border-slate-300 dark:hover:border-slate-600 transition-all active:scale-[0.98]"
              >
                Cancel
              </button>
              <button 
                onClick={handleSave} 
                disabled={saving} 
                className="flex-1 lg:flex-none px-8 py-3 lg:py-3.5 rounded-2xl bg-[#059467] text-white font-bold shadow-lg shadow-[#059467]/30 hover:bg-[#047854] transition-all active:scale-[0.98] disabled:opacity-70 disabled:active:scale-100 flex items-center justify-center gap-2"
              >
