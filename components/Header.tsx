...
const Header: React.FC = () => {
  ...
  return (
    <>
              ...
              {user ? (
                <>
                  ...
                  <button
                    ...
                    className="hidden lg:block relative size-10 rounded-full border-2 border-slate-200 dark:border-slate-700 hover:border-[#059467] transition-colors overflow-hidden group"
      ...
      {/* Mobile Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-[280px] bg-white dark:bg-[#0f231d] shadow-2xl z-50 transform transition-transform duration-300 ease-in-out lg:hidden ${
          ...
          <div className="p-4 border-t border-slate-200 dark:border-slate-800">
            {user ? (
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  onClick={toggleTheme}
                  className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors mb-2"
                >
                  {isDarkMode ? (
                    <>
                      <Sun className="w-4 h-4" />
